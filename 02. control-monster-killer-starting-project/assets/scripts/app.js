...
try {
    ...
    console.log(error);
    chosenMaxLife = 100;
    alert('You enterd something wrong, default value of 100 was used.')
} finally {
...
function endRound() {
    ...
    const playerDamage = dealPlayerDamage(MONSTER_MAX_VALUE);
    ...
    if ( currentMonsterHealth <= 0 && currentPlayerHealth > 0) {
        alert('You Win');
        writeLog(LOG_EVENT_GAME_OVER, 'PLAYER WIN!', currentMonsterHealth, currentPlayerHealth);
    } else if (currentPlayerHealth <= 0 && currentMonsterHealth > 0) {
        alert('You Lose');
        writeLog(LOG_EVENT_GAME_OVER, 'MONSTER WIN', currentMonsterHealth, currentPlayerHealth);
...
function printLogHandler() {
    ...
    //         if (k === 3) {
    //             break outerWhile;
    //             // continue outerWhile; // dangerous! => infinite while
    //         }
    //         console.log('inner', k);
    //     }
    //     j++;
